...
namespace IG.Lib.Events
{
    ...
    public class NotificationSubscription<TSender, TEventArgs, TFilterData> : INotificationSubscription<TSender, TEventArgs, TFilterData>
        where TSender : class
        where TFilterData : class
    {
        ...
        public NotificationSubscription(INotificationSubscriber<TSender, TEventArgs> notificationSubscriber,
            INotificationFilterWithData<TSender, TEventArgs, TFilterData> notificationFilter = null):
                this(notificationSubscriber, notificationFilter, typeof(TSender), typeof(TEventArgs), typeof(TFilterData))
        { }

        protected NotificationSubscription(INotificationSubscriber<TSender, TEventArgs> notificationSubscriber, 
            INotificationFilterWithData<TSender, TEventArgs, TFilterData> notificationFilter,
            Type senderType, Type eventArgsType, Type filterDataType)
        {
        ...
        public Type FilterDataType { get; private set; }
