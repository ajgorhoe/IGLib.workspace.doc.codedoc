<#
.SYNOPSIS
    Script for generating code documentation  (configuration ID "ModuleDoc";
	file ModuleDoc.dox - the modern IGLib with basic source code, and NO  
	sources included.
