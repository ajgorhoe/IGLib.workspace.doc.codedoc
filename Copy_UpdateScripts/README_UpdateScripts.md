...
**Scripts and repository clone** (usually the `codedoc/` directory) must be **at configured relative locations** with respect to the target code repository (for which documentation should be generated) for everything to work correctly:
