<#
.SYNOPSIS
    Script for generating code documentation (configuration ID "igliball_with_sources"; 
    file igliball_with_sources.dox - the LEGACY IGLib) with extended source code, and NO
    sources included.
...
$ConfigurationId = "igliball_with_sources"
