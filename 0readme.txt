...
Use if doxywizard is not very recommended, however, especially not to correct 
path information.

Note that the $ sign only indicates command shell's prompt and is not part of 
what you type in. 
