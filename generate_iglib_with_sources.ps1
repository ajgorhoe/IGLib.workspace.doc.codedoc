<#
.SYNOPSIS
    Script for generating code documentation (configuration ID "iglib_with_sources"; 
    file iglib_with_sources.dox - the LEGACY IGLib) with basic source code, and NO
    sources included.
...
$ConfigurationId = "iglib_with_sources"
