<#
.SYNOPSIS
    Script for generating code documentation (configuration ID "igliball"; 
    file igliball.dox - the LEGACY IGLib) with extended source code, and NO
    sources included.
